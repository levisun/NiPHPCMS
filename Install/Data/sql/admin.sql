...
(28, 'user', '管理员管理', 1, '管理员管理方法', 4, 25, 3),
...
CREATE TABLE IF NOT EXISTS `np_admin` (
  ...
  `lastloginipattr` varchar(255) NOT NULL DEFAULT '' COMMENT '登录IP地区',
...
INSERT INTO np_admin(`username`, `password`, `email`) VALUES('levisun', MD5('Horadric'), 'levisun@mail.com');